 ...
 */
export async function debugSetTokenAmount(chain, token, account, amount) {
    ...
    const structLogs = resp.structLogs || [];
    const sloads = structLogs.filter((log) => log.op === 'SLOAD');
    if (sloads.length == 0) {
...
//# sourceMappingURL=debugSetTokenAmount.js.map