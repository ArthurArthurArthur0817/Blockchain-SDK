import CrossChainPaymasterMetadata from '@eil-protocol/contracts/artifacts/src/CrossChainPaymaster.sol/CrossChainPaymaster.json';
import ICrossChainPaymaster from '@eil-protocol/contracts/artifacts/src/ICrossChainPaymaster.sol/ICrossChainPaymaster.json';
import L1AtomicSwapStakeManager from '@eil-protocol/contracts/artifacts/src/L1AtomicSwapStakeManager.sol/L1AtomicSwapStakeManager.json';
import SimplePaymasterMeta from '@eil-protocol/contracts/artifacts/src/SimplePaymaster.sol/SimplePaymaster.json';
import RuntimeVarsHelper from '@eil-protocol/contracts/artifacts/src/common/RuntimeVarsHelper.sol/RuntimeVarsHelper.json';
import AtomicSwapTypes from '@eil-protocol/contracts/artifacts/src/common/utils/AtomicSwapTypes.sol/AtomicSwapTypes.json';
import XlpSelectionHelper from '@eil-protocol/contracts/artifacts/src/common/utils/XlpSelectionHelper.sol/XlpSelectionHelper.json';
import CreateXMetadata from '@eil-protocol/contracts/artifacts/src/createx/CreateX.sol/CreateX.json';
import TestERC20Meta from '@eil-protocol/contracts/artifacts/src/test/TestERC20.sol/TestERC20.json';
declare const EntryPointMeta: {
    abi: readonly [{
